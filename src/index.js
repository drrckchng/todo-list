...
createTask("Task Two", "This is a task", new Date(2023, 2, 1), true, 0);
createTask("Task Three", "This is a task", new Date(2023, 2, 20), true, 0);
createTask("Task Four", "This is a task", new Date(2023, 2, 20), false, 0);
createTask("Task Four", "This is a task", new Date(2023, 2, 20), false, 0);
createTask("Eat cereal", "This is a task", new Date(2023, 2, 20), false, 1);
